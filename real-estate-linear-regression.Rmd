...
Let's get the summary for all of our variables with Price being our dependent variable and other variables being independent.
...
summary(model)
```
We can see that "Average Area Income" coefficient has the highest effect on price, followed by "Average Area House Age" and "Area Population".

Let's back this up with graphs:
...
The more money you earn the more you're willing to spend on housing? idk lol
